...
public class ParkingZonesController {
    ...
    public ParkingZonesController(UserService userService, RoleService roleService, ParkingZoneService parkingZoneService, EmployeeService employeeService, Application_longpassService applicationLongpassService) {
    ...
    public String userPage(Model model, @AuthenticationPrincipal User user) {
        ...
        return "/admin/parkingZones";
    }

    @PatchMapping("/parkingZones/{id}/update")
    public String update(ParkingZone parkingZone){
        parkingZoneService.updateParkingZone(parkingZone);
        return "redirect:/admin/parkingZones";
    }

    @DeleteMapping("/parkingZones/{id}/delete")
    public String delete(@PathVariable("id")Long id){
        parkingZoneService.deleteParkingZone(id);
        return "redirect:/admin/parkingZones";
    }

    @PostMapping("/parkingZones")
