...
public class EmployeesController {
    ...
    public EmployeesController(UserService userService, RoleService roleService, ParkingZoneService parkingZoneService, EmployeeService employeeService, Application_longpassService applicationLongpassService) {
    ...
    @PatchMapping("/employees/{id}/update")
